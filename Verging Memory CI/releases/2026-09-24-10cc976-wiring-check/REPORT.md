# Wiring check — Journey Rehearsal
...
- **Reports come back.** This page reached you through the same route every regression report uses (GET /v1/releases/run_20260924_8367fa679d39/report), and your integration commits it the same way.
...
Set `activation_id: act_ug8g7gs` to set up your agent. It costs 20 activation environments, plus any usage above your included allowances.
